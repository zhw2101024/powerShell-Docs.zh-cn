# <a name="microsoft-open-source-code-of-conduct"></a><span data-ttu-id="de44a-101">Microsoft 开放源代码行为准则</span><span class="sxs-lookup"><span data-stu-id="de44a-101">Microsoft Open Source Code of Conduct</span></span>
