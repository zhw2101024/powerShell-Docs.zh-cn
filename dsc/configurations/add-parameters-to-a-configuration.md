...
## <a name="fully-parameterized-configuration"></a><span data-ttu-id="0e7fe-148">完全参数化的配置</span><span class="sxs-lookup"><span data-stu-id="0e7fe-148">Fully parameterized Configuration</span></span>
