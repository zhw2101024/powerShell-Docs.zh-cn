...
<span data-ttu-id="45a10-103">在 WMF 5.0 RTM 版本中已将 PowerShell 脚本共享功能添加到了 PowerShellGet。</span><span class="sxs-lookup"><span data-stu-id="45a10-103">PowerShell Script sharing feature got added to the PowerShellGet in the WMF 5.0 RTM release.</span></span>
<span data-ttu-id="45a10-104">以下新的 cmdlet 将被添加到 PowerShellGet 模块以支持 PowerShell 脚本。</span><span class="sxs-lookup"><span data-stu-id="45a10-104">The following new cmdlets are added to the PowerShellGet module for supporting the PowerShell Scripts.</span></span>
```powershell
...
<span data-ttu-id="45a10-105">脚本共享 Cmdlet 的语法：</span><span class="sxs-lookup"><span data-stu-id="45a10-105">Syntax of script sharing Cmdlets:</span></span>
```powershell
