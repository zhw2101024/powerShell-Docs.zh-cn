...
- **WMF 5.1 需要 .NET Framework 4.5.2**。 安装将成功，但如果未安装 .NET 4.5.2，将无法使用主要功能。 相关说明请参见[安装和配置 WMF 5.1](https://msdn.microsoft.com/en-us/powershell/wmf/5.1/install-configure) 主题。
