...
有些系统的设置要求检查所有代码签名，因此需要手动批准 PowerShell 编辑器服务才能在系统上运行。
如果已经安装 PowerShell 扩展，但出现以下错误，那么更改执行策略的组策略更新可能是原因之一：
...
有关 VS Code 中文件编码的详细信息，请参阅[了解文件编码](understanding-file-encoding.md)。
