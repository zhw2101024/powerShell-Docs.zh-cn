...
## <a name="using-jea-with-powershell-direct"></a><span data-ttu-id="d6c61-148">将 JEA 与 PowerShell Direct 配合使用</span><span class="sxs-lookup"><span data-stu-id="d6c61-148">Using JEA with PowerShell Direct</span></span>
