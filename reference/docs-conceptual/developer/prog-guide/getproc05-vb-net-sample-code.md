---
title: GetProc05 （VB.NET）示例代码 |Microsoft Docs
ms.custom: ''
ms.date: 09/13/2016
ms.reviewer: ''
ms.suite: ''
...
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="76997-102">GetProc05 (VB.NET) 示例代码</span><span class="sxs-lookup"><span data-stu-id="76997-102">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="76997-103">下面是 GetProc05 示例 cmdlet 的完整 VB.NET 代码。</span><span class="sxs-lookup"><span data-stu-id="76997-103">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="76997-104">另请参阅</span><span class="sxs-lookup"><span data-stu-id="76997-104">See Also</span></span>

[<span data-ttu-id="76997-105">Windows PowerShell SDK</span><span class="sxs-lookup"><span data-stu-id="76997-105">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)