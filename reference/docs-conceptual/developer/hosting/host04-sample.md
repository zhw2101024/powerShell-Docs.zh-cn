...
---
# <a name="host04-sample"></a><span data-ttu-id="01dd2-102">Host04 示例</span><span class="sxs-lookup"><span data-stu-id="01dd2-102">Host04 Sample</span></span>

<span data-ttu-id="01dd2-103">此示例演示如何生成基于控制台的交互式主机应用程序，该应用程序可从命令行读取命令，执行命令，然后将结果显示到控制台。</span><span class="sxs-lookup"><span data-stu-id="01dd2-103">This sample shows how to build an interactive console-based host application that reads commands from the command line, executes the commands, and then displays the results to the console.</span></span> <span data-ttu-id="01dd2-104">此主机应用程序还支持显示允许用户指定多个选项的提示。</span><span class="sxs-lookup"><span data-stu-id="01dd2-104">This host application also supports displaying prompts that allow the user to specify multiple choices.</span></span>

## <a name="requirements"></a><span data-ttu-id="01dd2-105">要求</span><span class="sxs-lookup"><span data-stu-id="01dd2-105">Requirements</span></span>

 <span data-ttu-id="01dd2-106">此示例需要 Windows PowerShell 2.0。</span><span class="sxs-lookup"><span data-stu-id="01dd2-106">This sample requires Windows PowerShell 2.0.</span></span>

## <a name="demonstrates"></a><span data-ttu-id="01dd2-107">示例</span><span class="sxs-lookup"><span data-stu-id="01dd2-107">Demonstrates</span></span>

- <span data-ttu-id="01dd2-108">创建一个自定义宿主，其类派生自[PSHost](/dotnet/api/System.Management.Automation.Host.PSHost)类、 [Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface)类和[，后者派生自一个类。"Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) " 类。</span><span class="sxs-lookup"><span data-stu-id="01dd2-108">Creating a custom host whose classes derive from the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class, the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class, and the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class.</span></span>

- <span data-ttu-id="01dd2-109">构建一个控制台应用程序，该应用程序使用这些主机类来构建交互式 Windows PowerShell shell。</span><span class="sxs-lookup"><span data-stu-id="01dd2-109">Building a console application that uses these host classes to build an interactive Windows PowerShell shell.</span></span>

- <span data-ttu-id="01dd2-110">创建 @no__t 0 变量并加载以下配置文件。</span><span class="sxs-lookup"><span data-stu-id="01dd2-110">Creating a `$profile` variable and loading the following profiles.</span></span>

  - <span data-ttu-id="01dd2-111">当前用户、当前主机</span><span class="sxs-lookup"><span data-stu-id="01dd2-111">current user, current host</span></span>

  - <span data-ttu-id="01dd2-112">当前用户，所有主机</span><span class="sxs-lookup"><span data-stu-id="01dd2-112">current user, all hosts</span></span>

  - <span data-ttu-id="01dd2-113">所有用户，当前主机</span><span class="sxs-lookup"><span data-stu-id="01dd2-113">all users, current host</span></span>

  - <span data-ttu-id="01dd2-114">所有用户，所有主机</span><span class="sxs-lookup"><span data-stu-id="01dd2-114">all users, all hosts</span></span>

- <span data-ttu-id="01dd2-115">实现[Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection)接口的接口。</span><span class="sxs-lookup"><span data-stu-id="01dd2-115">Implement the [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) interface.</span></span>

## <a name="example"></a><span data-ttu-id="01dd2-116">示例</span><span class="sxs-lookup"><span data-stu-id="01dd2-116">Example</span></span>

 <span data-ttu-id="01dd2-117">此示例允许用户在命令行中输入命令，处理这些命令，然后输出结果。</span><span class="sxs-lookup"><span data-stu-id="01dd2-117">This example allows the user to enter commands at a command line, processes those commands, and then prints out the results.</span></span>
...
## <a name="example"></a><span data-ttu-id="01dd2-118">示例</span><span class="sxs-lookup"><span data-stu-id="01dd2-118">Example</span></span>

 <span data-ttu-id="01dd2-119">下面的代码是此主机应用程序所使用的[PSHost](/dotnet/api/System.Management.Automation.Host.PSHost)类的实现方式。</span><span class="sxs-lookup"><span data-stu-id="01dd2-119">The following code is the implementation of the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class that is used by this host application.</span></span> <span data-ttu-id="01dd2-120">未实现的那些元素会引发异常或不返回任何内容。</span><span class="sxs-lookup"><span data-stu-id="01dd2-120">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="example"></a><span data-ttu-id="01dd2-121">示例</span><span class="sxs-lookup"><span data-stu-id="01dd2-121">Example</span></span>

 <span data-ttu-id="01dd2-122">下面的代码是此主机应用程序所使用的[Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface)类的实现方式。</span><span class="sxs-lookup"><span data-stu-id="01dd2-122">The following code is the implementation of the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class that is used by this host application.</span></span>
...
## <a name="example"></a><span data-ttu-id="01dd2-123">示例</span><span class="sxs-lookup"><span data-stu-id="01dd2-123">Example</span></span>

 <span data-ttu-id="01dd2-124">下面的代码是此主机应用程序所使用的[Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface)类的实现方式。</span><span class="sxs-lookup"><span data-stu-id="01dd2-124">The following code is the implementation of the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class that is used by this host application.</span></span> <span data-ttu-id="01dd2-125">未实现的那些元素会引发异常或不返回任何内容。</span><span class="sxs-lookup"><span data-stu-id="01dd2-125">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="01dd2-126">另请参阅</span><span class="sxs-lookup"><span data-stu-id="01dd2-126">See Also</span></span>

 [<span data-ttu-id="01dd2-127">"PSHost"。</span><span class="sxs-lookup"><span data-stu-id="01dd2-127">System.Management.Automation.Host.PSHost</span></span>](/dotnet/api/System.Management.Automation.Host.PSHost)

 [<span data-ttu-id="01dd2-128">"Pshostuserinterface"。</span><span class="sxs-lookup"><span data-stu-id="01dd2-128">System.Management.Automation.Host.Pshostuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface)

 [<span data-ttu-id="01dd2-129">"Pshostrawuserinterface"。</span><span class="sxs-lookup"><span data-stu-id="01dd2-129">System.Management.Automation.Host.Pshostrawuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface)
