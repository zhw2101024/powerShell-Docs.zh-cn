...
4. <span data-ttu-id="d388c-114">对于自定义作业对象，请实现 job 类。</span><span class="sxs-lookup"><span data-stu-id="d388c-114">For custom job objects, implement the job class.</span></span>
