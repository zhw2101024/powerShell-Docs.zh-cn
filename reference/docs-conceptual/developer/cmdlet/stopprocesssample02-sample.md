...
3. <span data-ttu-id="3c38b-111">在 "**生成**" 菜单中，选择 "**生成解决方案**"。</span><span class="sxs-lookup"><span data-stu-id="3c38b-111">In the **Build** menu, select **Build Solution**.</span></span>
