...
3. <span data-ttu-id="0f0e2-110">在“生成”菜单中选择“生成解决方案”。</span><span class="sxs-lookup"><span data-stu-id="0f0e2-110">In the **Build** menu, select **Build Solution**.</span></span>
