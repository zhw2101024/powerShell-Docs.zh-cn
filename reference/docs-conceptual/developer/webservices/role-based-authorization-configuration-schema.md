...
---
# <a name="role-based-authorization-configuration-schema"></a><span data-ttu-id="cfa12-102">基于角色的授权配置架构</span><span class="sxs-lookup"><span data-stu-id="cfa12-102">Role-Based Authorization Configuration Schema</span></span>

<span data-ttu-id="cfa12-103">[PswsRoleBasedPlugins](https://go.microsoft.com/fwlink/?LinkId=243041)示例使用 XML 文件来配置授权策略。</span><span class="sxs-lookup"><span data-stu-id="cfa12-103">The [PswsRoleBasedPlugins](https://go.microsoft.com/fwlink/?LinkId=243041) sample uses XML files to configure the authorization policy.</span></span> <span data-ttu-id="cfa12-104">以下 XSD 定义了用于这些文件的架构。</span><span class="sxs-lookup"><span data-stu-id="cfa12-104">The following XSD defines the schema used for these files.</span></span>
