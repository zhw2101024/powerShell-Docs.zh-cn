# <a name="powershell-core-support-lifecycle"></a><span data-ttu-id="fe00a-101">PowerShell Core 支持生命周期</span><span class="sxs-lookup"><span data-stu-id="fe00a-101">PowerShell Core Support Lifecycle</span></span>
