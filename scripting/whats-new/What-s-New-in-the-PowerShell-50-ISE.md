...
Windows PowerShell ISE 是一款主机应用程序，让你可以在直观的图形环境中编写、运行和测试脚本与模块。 其语法着色、Tab 自动补全、可视调试、Unicode 遵从以及上下文相关帮助等主要功能可为你提供丰富的脚本编写体验。
...
Windows PowerShell ISE 现在支持附加工具，这些工具是通过使用对象模型添加的 Windows Presentation Foundation (WPF) 控件。 附加工具可以在控制台窗格中垂直或水平显示。 窗格中的多个附加工具显示为选项卡式控件。 你还可以添加或删除由 Microsoft 以外的参与方创建的附加工具。 有关如何导入或删除附加工具的详细信息，请参阅 [Windows PowerShell ISE 操作](http://technet.microsoft.com/library/cc732148.aspx)。

**这一更改增添了什么价值？**

附加工具让你能够使用工具扩展和自定义 Windows PowerShell ISE，这些工具可以实现更好的脚本编写效果或向 Windows PowerShell ISE 添加功能。

**工作原理的不同之处是什么？**

Windows PowerShell ISE 3.0 版及更高版本附带“**命令**”附加工具。 “**命令**”附加工具让你能够浏览 cmdlet，并使用“**脚本**”和“**控制台**”窗格并行访问有关 cmdlet 的帮助。

可通过使用“**附加设备**”菜单上的“**打开附加工具网站**”命令找到其他附加设备。
...
-   **块选择** 你可以通过在用鼠标选定脚本窗格中文本的同时按住 ALT 键，或通过按 **Alt\+Shift\+箭头键** 来选定文本块。
