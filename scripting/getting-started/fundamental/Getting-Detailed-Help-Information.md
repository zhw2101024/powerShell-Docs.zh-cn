...
可以在命令提示符下显示这些帮助主题，或在 Microsoft TechNet 库中查看这些主题的最近更新的版本。 许多托管 Windows PowerShell 的程序（如 Windows PowerShell 集成脚本环境）提供了其他帮助功能，如上下文相关帮助和编译的帮助文件 (.chm)。
...
若要显示有关 cmdlet、函数或脚本的详细信息，包括其参数的说明及其用法的示例，请使用 Get\-Help cmdlet 的 *Detailed* 参数。 例如，若要获取有关 Get\-ChildItem cmdlet 的详细信息，请键入：
...
## 获取概念帮助
Get\-Help cmdlet 也将显示有关 Windows PowerShell 中的概念主题（包括有关 Windows PowerShell 语言的主题）的信息。 概念帮助主题以“about\_”前缀开头，例如 about\_line\_editing。 （概念主题的名称必须用英文输入，即使在非英语版本的 Windows PowerShell 中也是如此。）
...
Get\-Help 的参数（例如 *Detailed*、*Parameter* 和 *Examples*）对概念帮助主题的显示没有影响。
...
Get\-Help 的参数（例如 *Detailed*、*Parameter* 和 *Examples*）对提供程序帮助主题的显示没有影响。
...
例如，如果 C:\\PS\-Test 目录中有一个名为“TestScript.ps1”的脚本，若要显示有关该脚本的帮助主题，请键入：
