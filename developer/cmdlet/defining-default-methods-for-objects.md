...
> [!NOTE]
> 以下部分中的示例来自 Windows PowerShell 安装`Types.ps1xml`目录（`$PSHOME`）中的类型文件。 有关详细信息，请参阅[关于 types.ps1xml](/powershell/module/microsoft.powershell.core/about/about_types.ps1xml)。
