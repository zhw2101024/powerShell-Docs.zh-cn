...
下面是 Runspace02 示例 VB.NET 源代码。 此示例使用[System.Management.Automation.Runspaceinvoke](/dotnet/api/System.Management.Automation.RunspaceInvoke)类来执行`Get-Process`cmdlet 以同步方式。 然后将 Windows 窗体和数据绑定使用 DataGridView 控件中显示结果。
