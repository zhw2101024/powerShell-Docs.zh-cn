...
下面是 StopProc01 示例 cmdlet 的代码示例。 这是`Stop-Process`cmdlet 示例中所述[创建一个 Cmdlet 来修改系统](../cmdlet/creating-a-cmdlet-that-modifies-the-system.md)。 `Stop-Process` Cmdlet 旨在用于停止使用 Get-proc cmdlet 检索的进程 (中所述[创建第一个 Cmdlet](../cmdlet/creating-a-cmdlet-without-parameters.md))。
