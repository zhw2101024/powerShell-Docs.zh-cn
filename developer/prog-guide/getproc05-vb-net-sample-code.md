...
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="c2f66-102">GetProc05 (VB.NET) 示例代码</span><span class="sxs-lookup"><span data-stu-id="c2f66-102">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="c2f66-103">下面是 GetProc05 示例 cmdlet 的完整 VB.NET 代码。</span><span class="sxs-lookup"><span data-stu-id="c2f66-103">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="c2f66-104">另请参阅</span><span class="sxs-lookup"><span data-stu-id="c2f66-104">See Also</span></span>

[<span data-ttu-id="c2f66-105">Windows PowerShell SDK</span><span class="sxs-lookup"><span data-stu-id="c2f66-105">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)