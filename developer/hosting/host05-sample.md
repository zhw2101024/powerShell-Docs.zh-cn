---
title: Host05 示例 |Microsoft Docs
ms.custom: ''
ms.date: 09/13/2016
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "56863793"
---
# <a name="host05-sample"></a><span data-ttu-id="ba9c3-102">Host05 示例</span><span class="sxs-lookup"><span data-stu-id="ba9c3-102">Host05 Sample</span></span>

<span data-ttu-id="ba9c3-103">此示例演示如何生成基于控制台的交互式主机应用程序，从命令行读取并执行命令，然后将结果显示到控制台。</span><span class="sxs-lookup"><span data-stu-id="ba9c3-103">This sample shows how to build an interactive console-based host application that reads commands from the command line, executes the commands, and then displays the results to the console.</span></span> <span data-ttu-id="ba9c3-104">此主机应用程序还支持通过使用 [Enter-PsSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) 和 [Exit-PsSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) cmdlet 调用远程计算机。</span><span class="sxs-lookup"><span data-stu-id="ba9c3-104">This host application also supports calls to remote computers by using the [Enter-PsSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) and [Exit-PsSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) cmdlets.</span></span>
<span data-ttu-id="ba9c3-105">此示例演示如何生成基于控制台的交互式主机应用程序，从命令行读取并执行命令，然后将结果显示到控制台。</span><span class="sxs-lookup"><span data-stu-id="ba9c3-105">This sample shows how to build an interactive console-based host application that reads commands from the command line, executes the commands, and then displays the results to the console.</span></span> <span data-ttu-id="ba9c3-106">此主机应用程序还支持通过使用 [Enter-PsSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) 和 [Exit-PsSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) cmdlet 调用远程计算机。</span><span class="sxs-lookup"><span data-stu-id="ba9c3-106">This host application also supports calls to remote computers by using the [Enter-PsSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) and [Exit-PsSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) cmdlets.</span></span>

## <a name="requirements"></a><span data-ttu-id="ba9c3-107">要求</span><span class="sxs-lookup"><span data-stu-id="ba9c3-107">Requirements</span></span>

- <span data-ttu-id="ba9c3-108">此示例要求 Windows PowerShell 2.0。</span><span class="sxs-lookup"><span data-stu-id="ba9c3-108">This sample requires Windows PowerShell 2.0.</span></span>

- <span data-ttu-id="ba9c3-109">必须在提升模式下 （以管理员身份运行） 运行此应用程序。</span><span class="sxs-lookup"><span data-stu-id="ba9c3-109">This application must be run in elevated mode (Run as administrator).</span></span>

## <a name="demonstrates"></a><span data-ttu-id="ba9c3-110">说明</span><span class="sxs-lookup"><span data-stu-id="ba9c3-110">Demonstrates</span></span>

- <span data-ttu-id="ba9c3-111">创建自定义主机的类派生自[System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost)类， [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface)类，并且[System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface)类。</span><span class="sxs-lookup"><span data-stu-id="ba9c3-111">Creating a custom host whose classes derive from the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class, the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class, and the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class.</span></span>

- <span data-ttu-id="ba9c3-112">生成控制台应用程序使用这些主机类来构建交互式 Windows PowerShell shell。</span><span class="sxs-lookup"><span data-stu-id="ba9c3-112">Building a console application that uses these host classes to build an interactive Windows PowerShell shell.</span></span>

- <span data-ttu-id="ba9c3-113">创建`$profile`变量和加载以下配置文件。</span><span class="sxs-lookup"><span data-stu-id="ba9c3-113">Creating a `$profile` variable and loading the following profiles.</span></span>

  - <span data-ttu-id="ba9c3-114">当前用户，当前主机</span><span class="sxs-lookup"><span data-stu-id="ba9c3-114">current user, current host</span></span>

  - <span data-ttu-id="ba9c3-115">当前用户，所有主机</span><span class="sxs-lookup"><span data-stu-id="ba9c3-115">current user, all hosts</span></span>

  - <span data-ttu-id="ba9c3-116">所有用户，当前主机</span><span class="sxs-lookup"><span data-stu-id="ba9c3-116">all users, current host</span></span>

  - <span data-ttu-id="ba9c3-117">所有用户，所有主机</span><span class="sxs-lookup"><span data-stu-id="ba9c3-117">all users, all hosts</span></span>

- <span data-ttu-id="ba9c3-118">实现[System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection)接口。</span><span class="sxs-lookup"><span data-stu-id="ba9c3-118">Implement the [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) interface.</span></span>

- <span data-ttu-id="ba9c3-119">实现[System.Management.Automation.Host.Ihostsupportsinteractivesession](/dotnet/api/System.Management.Automation.Host.IHostSupportsInteractiveSession)接口以支持通过使用交互式远程处理[Enter-pssession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession)和[Exit-pssession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) cmdlet。</span><span class="sxs-lookup"><span data-stu-id="ba9c3-119">Implement the [System.Management.Automation.Host.Ihostsupportsinteractivesession](/dotnet/api/System.Management.Automation.Host.IHostSupportsInteractiveSession) interface to support interactive remoting by using the [Enter-PsSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) and [Exit-PsSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) cmdlets.</span></span>
- <span data-ttu-id="ba9c3-120">实现[System.Management.Automation.Host.Ihostsupportsinteractivesession](/dotnet/api/System.Management.Automation.Host.IHostSupportsInteractiveSession)接口以支持通过使用交互式远程处理[Enter-pssession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession)和[Exit-pssession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) cmdlet。</span><span class="sxs-lookup"><span data-stu-id="ba9c3-120">Implement the [System.Management.Automation.Host.Ihostsupportsinteractivesession](/dotnet/api/System.Management.Automation.Host.IHostSupportsInteractiveSession) interface to support interactive remoting by using the [Enter-PsSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) and [Exit-PsSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) cmdlets.</span></span>

## <a name="example"></a><span data-ttu-id="ba9c3-121">示例</span><span class="sxs-lookup"><span data-stu-id="ba9c3-121">Example</span></span>

 <span data-ttu-id="ba9c3-122">此示例允许用户输入的命令行上的命令，处理这些命令，然后打印出结果。</span><span class="sxs-lookup"><span data-stu-id="ba9c3-122">This example allows the user to enter commands at a command line, processes those commands, and then prints out the results.</span></span>
...
## <a name="example"></a><span data-ttu-id="ba9c3-123">示例</span><span class="sxs-lookup"><span data-stu-id="ba9c3-123">Example</span></span>

 <span data-ttu-id="ba9c3-124">下面的代码是实现[System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost)此主机应用程序使用的类。</span><span class="sxs-lookup"><span data-stu-id="ba9c3-124">The following code is the implementation of the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class that is used by this host application.</span></span> <span data-ttu-id="ba9c3-125">未实现这些元素引发异常或返回任何内容。</span><span class="sxs-lookup"><span data-stu-id="ba9c3-125">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="example"></a><span data-ttu-id="ba9c3-126">示例</span><span class="sxs-lookup"><span data-stu-id="ba9c3-126">Example</span></span>

 <span data-ttu-id="ba9c3-127">下面的代码是实现[System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface)此主机应用程序使用的类。</span><span class="sxs-lookup"><span data-stu-id="ba9c3-127">The following code is the implementation of the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class that is used by this host application.</span></span>
...
## <a name="example"></a><span data-ttu-id="ba9c3-128">示例</span><span class="sxs-lookup"><span data-stu-id="ba9c3-128">Example</span></span>

 <span data-ttu-id="ba9c3-129">下面的代码是实现[System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface)此主机应用程序使用的类。</span><span class="sxs-lookup"><span data-stu-id="ba9c3-129">The following code is the implementation of the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class that is used by this host application.</span></span> <span data-ttu-id="ba9c3-130">未实现这些元素引发异常或返回任何内容。</span><span class="sxs-lookup"><span data-stu-id="ba9c3-130">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="ba9c3-131">另请参阅</span><span class="sxs-lookup"><span data-stu-id="ba9c3-131">See Also</span></span>

 [<span data-ttu-id="ba9c3-132">System.Management.Automation.Host.PSHost</span><span class="sxs-lookup"><span data-stu-id="ba9c3-132">System.Management.Automation.Host.PSHost</span></span>](/dotnet/api/System.Management.Automation.Host.PSHost)

 [<span data-ttu-id="ba9c3-133">System.Management.Automation.Host.Pshostuserinterface</span><span class="sxs-lookup"><span data-stu-id="ba9c3-133">System.Management.Automation.Host.Pshostuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface)

 [<span data-ttu-id="ba9c3-134">System.Management.Automation.Host.Pshostrawuserinterface</span><span class="sxs-lookup"><span data-stu-id="ba9c3-134">System.Management.Automation.Host.Pshostrawuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface)
