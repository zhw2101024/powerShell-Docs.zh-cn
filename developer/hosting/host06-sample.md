...
ms.locfileid: "62082866"
---
# <a name="host06-sample"></a><span data-ttu-id="c0388-102">Host06 示例</span><span class="sxs-lookup"><span data-stu-id="c0388-102">Host06 Sample</span></span>

<span data-ttu-id="c0388-103">此示例演示如何生成基于控制台的交互式主机应用程序，从命令行读取并执行命令，然后将结果显示到控制台。</span><span class="sxs-lookup"><span data-stu-id="c0388-103">This sample shows how to build an interactive console-based host application that reads commands from the command line, executes the commands, and then displays the results to the console.</span></span> <span data-ttu-id="c0388-104">此外，此示例还使用了 Tokenizer API 来指定用户输入的文本颜色。</span><span class="sxs-lookup"><span data-stu-id="c0388-104">In addition, this sample uses the Tokenizer APIs to specify the color of the text that is entered by the user.</span></span>

## <a name="requirements"></a><span data-ttu-id="c0388-105">要求</span><span class="sxs-lookup"><span data-stu-id="c0388-105">Requirements</span></span>

- <span data-ttu-id="c0388-106">此示例要求 Windows PowerShell 2.0。</span><span class="sxs-lookup"><span data-stu-id="c0388-106">This sample requires Windows PowerShell 2.0.</span></span>

- <span data-ttu-id="c0388-107">必须在提升模式下 （以管理员身份运行） 运行此应用程序。</span><span class="sxs-lookup"><span data-stu-id="c0388-107">This application must be run in elevated mode (Run as administrator).</span></span>

## <a name="demonstrates"></a><span data-ttu-id="c0388-108">演示</span><span class="sxs-lookup"><span data-stu-id="c0388-108">Demonstrates</span></span>

- <span data-ttu-id="c0388-109">创建自定义主机的类派生自[System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost)类， [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface)类，并且[System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface)类。</span><span class="sxs-lookup"><span data-stu-id="c0388-109">Creating a custom host whose classes derive from the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class, the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class, and the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class.</span></span>

- <span data-ttu-id="c0388-110">生成控制台应用程序使用这些主机类来构建交互式 Windows PowerShell shell。</span><span class="sxs-lookup"><span data-stu-id="c0388-110">Building a console application that uses these host classes to build an interactive Windows PowerShell shell.</span></span>

- <span data-ttu-id="c0388-111">创建`$profile`变量和加载以下配置文件。</span><span class="sxs-lookup"><span data-stu-id="c0388-111">Creating a `$profile` variable and loading the following profiles.</span></span>

  - <span data-ttu-id="c0388-112">当前用户，当前主机</span><span class="sxs-lookup"><span data-stu-id="c0388-112">current user, current host</span></span>

  - <span data-ttu-id="c0388-113">当前用户，所有主机</span><span class="sxs-lookup"><span data-stu-id="c0388-113">current user, all hosts</span></span>

  - <span data-ttu-id="c0388-114">所有用户，当前主机</span><span class="sxs-lookup"><span data-stu-id="c0388-114">all users, current host</span></span>

  - <span data-ttu-id="c0388-115">所有用户，所有主机</span><span class="sxs-lookup"><span data-stu-id="c0388-115">all users, all hosts</span></span>

- <span data-ttu-id="c0388-116">实现[System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection)接口。</span><span class="sxs-lookup"><span data-stu-id="c0388-116">Implement the [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) interface.</span></span>

- <span data-ttu-id="c0388-117">实现[System.Management.Automation.Host.Ihostsupportsinteractivesession](/dotnet/api/System.Management.Automation.Host.IHostSupportsInteractiveSession)接口以支持通过使用交互式远程处理[Enter-pssession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession)和[Exit-pssession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) cmdlet。</span><span class="sxs-lookup"><span data-stu-id="c0388-117">Implement the [System.Management.Automation.Host.Ihostsupportsinteractivesession](/dotnet/api/System.Management.Automation.Host.IHostSupportsInteractiveSession) interface to support interactive remoting by using the [Enter-PsSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) and [Exit-PsSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) cmdlets.</span></span>

- <span data-ttu-id="c0388-118">使用标记 API 着色，键入时让命令行。</span><span class="sxs-lookup"><span data-stu-id="c0388-118">Use the Tokenize API to colorize the command line as it is typed.</span></span>

## <a name="example"></a><span data-ttu-id="c0388-119">示例</span><span class="sxs-lookup"><span data-stu-id="c0388-119">Example</span></span>

 <span data-ttu-id="c0388-120">此示例允许用户输入的命令行上的命令，处理这些命令，然后打印出结果。</span><span class="sxs-lookup"><span data-stu-id="c0388-120">This example allows the user to enter commands at a command line, processes those commands, and then prints out the results.</span></span>
...
## <a name="example"></a><span data-ttu-id="c0388-121">示例</span><span class="sxs-lookup"><span data-stu-id="c0388-121">Example</span></span>

 <span data-ttu-id="c0388-122">下面的代码是实现[System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost)此主机应用程序使用的类。</span><span class="sxs-lookup"><span data-stu-id="c0388-122">The following code is the implementation of the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class that is used by this host application.</span></span> <span data-ttu-id="c0388-123">未实现这些元素引发异常或返回任何内容。</span><span class="sxs-lookup"><span data-stu-id="c0388-123">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="example"></a><span data-ttu-id="c0388-124">示例</span><span class="sxs-lookup"><span data-stu-id="c0388-124">Example</span></span>

 <span data-ttu-id="c0388-125">下面的代码是实现[System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface)此主机应用程序使用的类。</span><span class="sxs-lookup"><span data-stu-id="c0388-125">The following code is the implementation of the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class that is used by this host application.</span></span>
...
## <a name="example"></a><span data-ttu-id="c0388-126">示例</span><span class="sxs-lookup"><span data-stu-id="c0388-126">Example</span></span>

 <span data-ttu-id="c0388-127">下面的代码是实现[System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface)此主机应用程序使用的类。</span><span class="sxs-lookup"><span data-stu-id="c0388-127">The following code is the implementation of the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class that is used by this host application.</span></span> <span data-ttu-id="c0388-128">未实现这些元素引发异常或返回任何内容。</span><span class="sxs-lookup"><span data-stu-id="c0388-128">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="example"></a><span data-ttu-id="c0388-129">示例</span><span class="sxs-lookup"><span data-stu-id="c0388-129">Example</span></span>

 <span data-ttu-id="c0388-130">下面的代码读取命令行和颜色的文本输入。</span><span class="sxs-lookup"><span data-stu-id="c0388-130">The following code reads the command line and colors the text as it is entered.</span></span> <span data-ttu-id="c0388-131">使用确定令牌[System.Management.Automation.Psparser.Tokenize\*](/dotnet/api/System.Management.Automation.PSParser.Tokenize)方法。</span><span class="sxs-lookup"><span data-stu-id="c0388-131">Tokens are determined by using the [System.Management.Automation.Psparser.Tokenize\*](/dotnet/api/System.Management.Automation.PSParser.Tokenize) method.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="c0388-132">另请参阅</span><span class="sxs-lookup"><span data-stu-id="c0388-132">See Also</span></span>

 [<span data-ttu-id="c0388-133">System.Management.Automation.Host.PSHost</span><span class="sxs-lookup"><span data-stu-id="c0388-133">System.Management.Automation.Host.PSHost</span></span>](/dotnet/api/System.Management.Automation.Host.PSHost)

 [<span data-ttu-id="c0388-134">System.Management.Automation.Host.Pshostuserinterface</span><span class="sxs-lookup"><span data-stu-id="c0388-134">System.Management.Automation.Host.Pshostuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface)

 [<span data-ttu-id="c0388-135">System.Management.Automation.Host.Pshostrawuserinterface</span><span class="sxs-lookup"><span data-stu-id="c0388-135">System.Management.Automation.Host.Pshostrawuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface)
