...
---
# <a name="resource-mapping-schema"></a>资源映射架构

管理 OData IIS 扩展使用 XML 文件来定义资源映射。 以下 XSD 定义用于这些文件的架构。

## <a name="resource-mapping-file-xsd"></a>资源映射文件 XSD

以下 XSD 定义管理 OData IIS 扩展资源映射文件的架构。
