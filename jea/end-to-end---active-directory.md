...
translationtype: HT
---
# <a name="end-to-end---active-directory"></a>端到端 - Active Directory
假设你的程序作用域扩大了。
...
## <a name="steps-to-make-a-new-role-capability-and-session-configuration"></a>创建新角色功能和会话配置的步骤
...
## <a name="step-1-identify-what-needs-to-be-exposed"></a>步骤 1：确定需要公开的内容
...
## <a name="step-2-restrict-tasks-as-necessary"></a>步骤 2：根据需要限制任务
...
2.  `Add-ADGroupMember` 和 `Remove-ADGroupMember` 应仅适用于特定组

### <a name="step-3-confirm-the-tasks-work-with-jea"></a>步骤 3：确认任务适用 JEA
...
### <a name="aside-adding-a-function-to-your-module"></a>保留：将函数添加到模块
...
## <a name="step-4-edit-the-role-capability-file"></a>步骤 4：编辑角色功能文件
...
## <a name="step-5-register-a-new-session-configuration"></a>步骤 5：注册新会话配置
